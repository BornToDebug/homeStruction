...
urlpatterns = [
    ...
    url(r'^stream/androidstart/$', commandview.androidStartstream, name='androidstartstream'),
    url(r'^stream/androidstop/$',  commandview.androidStopstream, name='androidstopstream'),
